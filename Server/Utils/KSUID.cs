...
public class KSUID
{
       ...
       /// <summary>
       /// KSUID are 20 bytes when binary encoded.
       /// </summary>
       ...
       /// </summary>
       private static readonly DateTime MaxTimestamp = new(678305640950000000L, DateTimeKind.Utc);

       /// <summary>
       /// Gets a <see cref="DateTime" /> object that is set to the beginning of the KSUID epoch expressed in UTC.
       /// </summary>
       private static readonly DateTime MinTimestamp = new(KsuidEpochSeconds * TimeSpan.TicksPerSecond, DateTimeKind.Utc);
       ...
       public static string NewKsuid(DateTime utcTime, ReadOnlySpan<char> prefix)
       {
           ...
           SecureRandom.Fill(ksuid.Slice(TimestampLengthInBytes, PayloadLengthInBytes));
